export const zhCN = {
  ...
  'tools.inGameAutoPopup.description': '进入游戏后自动打开一个客户端弹窗；全局战力分析和装备推荐互斥，只会弹出当前选择的一项。',
...
export const enUS: Record<keyof typeof zhCN, string> = {
  ...
  'tools.inGameAutoPopup.description': 'Automatically open one client-side popup after entering game. Team analysis and build recommendations are mutually exclusive.',
