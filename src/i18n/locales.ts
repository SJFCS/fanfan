export const zhCN = {
  ...
  'beautify.assets.folderDescription': '打开 FanFan 的 assets 目录，你的自定义图片、视频等资源应该放在这里。',
  'beautify.assets.inputTitle': '录入资源',
  'beautify.assets.inputDescription': '输入相对于 assets 目录的图片或视频路径，FanFan 会保存到资源列表并展示预览。',
...
export const enUS: Record<keyof typeof zhCN, string> = {
  ...
  'beautify.assets.folderDescription': 'Open FanFan assets folder. Put your custom images and videos here.',
  'beautify.assets.inputTitle': 'Add Asset',
  'beautify.assets.inputDescription': 'Enter an image or video path relative to assets. FanFan will save it and show a preview.',
