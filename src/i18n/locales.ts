export const zhCN = {
  ...
  'tools.hextechAramAutoLock.title': '海克斯大乱斗秒抢英雄',
  'tools.hextechAramAutoLock.description': '进入海克斯大乱斗时，按独立英雄顺序从共享池中自动换取目标英雄。',
  'tools.hextechAramAutoLock.searchPlaceholder': '搜索海克斯目标英雄',
  'tools.hextechAramAutoLock.empty': '还没有添加海克斯大乱斗目标英雄，按优先级从左到右尝试。',
...
export const enUS: Record<keyof typeof zhCN, string> = {
  ...
  'tools.autoLock.empty': 'No priority champions yet. FanFan tries them from left to right.',
  'tools.hextechAramAutoLock.title': 'Hextech ARAM Auto Pick',
  'tools.hextechAramAutoLock.description': 'When entering Hextech ARAM, automatically swap from the bench by its own priority list.',
  'tools.hextechAramAutoLock.searchPlaceholder': 'Search Hextech target champion',
  'tools.hextechAramAutoLock.empty': 'No Hextech ARAM target champions yet. FanFan tries them from left to right.',
