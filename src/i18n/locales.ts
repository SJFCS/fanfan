export const zhCN = {
  ...
  'tools.group.configLock': '配置锁定',
  'tools.group.configLock.description': '切换账号时保留你的游戏配置，避免按键、画面等设置被客户端覆盖。',
  ...
  'tools.spectate.description': '通过可观战好友的 spectatorKey 调起观战。需要客户端处于空闲状态，且目标对局允许观战。',
...
export const enUS: Record<keyof typeof zhCN, string> = {
  ...
  'tools.group.configLock.description': 'Keep your game settings when switching accounts so you do not need to redo keybinds, visuals, and other tweaks.',
  ...
  'tools.spectate.description': 'Launch spectator mode using a watchable friend spectatorKey. The client must be idle and the target game must allow spectating.',
