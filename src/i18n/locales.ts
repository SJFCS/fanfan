export const zhCN = {
  ...
  'tools.readyCheckReselect.title': '匹配确认改选',
  'tools.readyCheckReselect.description': '匹配确认倒计时未结束时，点过接受或拒绝后仍可再次切换选择。',
  ...
  'tools.champSelectQuitButton.description': '非自定义对局的英雄选择里客户端不会显示退出按钮，Sona 帮你补一个。点击后会弹确认窗，秒退会扣逃跑分。',
  ...
  'tools.autoFastReturn.title': '急速返回房间',
  'tools.autoFastReturn.description': '结算阶段优先返回原房间，不等待点赞完成；若自动点赞开启，Sona 会在后台尽力补点。',
  'tools.autoHonor.title': '对局结束自动点赞',
  'tools.autoHonor.description': '对局结束后，随机给队友点赞，再也不用手点啦。',
  'tools.autoMatchmaking.title': '自动开始匹配',
...
export const enUS: Record<keyof typeof zhCN, string> = {
  ...
  'tools.readyCheckReselect.title': 'Match Confirmation Reselect',
  'tools.readyCheckReselect.description': 'Allow switching between accept and decline again while match confirmation is still counting down.',
  ...
  'tools.champSelectQuitButton.description': 'Adds a quit button in non-custom champ select. Clicking it opens a confirmation dialog; dodging may trigger queue penalties.',
  ...
  'tools.autoFastReturn.title': 'Fast Return to Lobby',
  'tools.autoFastReturn.description': 'Return to the original lobby first without waiting for honors; if Auto Honor is enabled, Sona will try to honor in the background.',
