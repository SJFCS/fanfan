export const zhCN = {
  ...
  'tools.autoLock.title': '普通选人秒抢英雄',
  'tools.autoLock.description': '适用于匹配、排位等有正常选人回合的模式；轮到自己选择时，按优先级自动预选或锁定目标英雄。大乱斗、海克斯大乱斗等卡池模式请使用“卡池秒选英雄”。',
  'tools.autoLock.searchPlaceholder': '输入英雄名/称号搜索',
  'tools.autoLock.lock': '秒选并锁定',
  'tools.autoLock.preselect': '仅预选',
  'tools.autoLock.empty': '还没有添加普通选人目标英雄，按优先级从左到右尝试。',
  'tools.hextechAramAutoLock.title': '卡池秒选英雄',
  'tools.hextechAramAutoLock.description': '适用于大乱斗、海克斯大乱斗等有发牌卡池、共享池或板凳池的模式；按独立英雄优先级自动抢发牌或从池子里换取目标英雄。',
